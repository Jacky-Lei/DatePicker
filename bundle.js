...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      '  Please insert dates in mm ⁄ dd ⁄ yyyy format'
	    );
	  }
	});
	...
	var MonthHeader = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'span',
	        { className: 'move-left', onClick: this.props.moveBack },
	        '< '
	      ),
	      React.createElement(
	        'span',
	      ...
	      React.createElement(
	        'span',
	        { className: 'move-right', onClick: this.props.moveForward },
	        '> '
	      )
	    );
	  }
	...
	var Weeks = React.createClass({
	  ...
	  render: function () {
	    ...
	    var renderWeeks = starts.map(function (start, index) {
	      return React.createElement(WeekRow, {
	        key: index,
	        start: start,
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(DatePicker, null), document.getElementById('main'));
	});
